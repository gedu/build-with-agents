...
| `research/` | Received links, contrasted against evidence, each with a verdict | Verdict only, as evidence | 5 verdicts (1 `supported`, 2 `partially supported`, 2 `unverifiable`) |
