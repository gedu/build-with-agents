...
| `research/` | Received links, contrasted against evidence, each with a verdict | Verdict only, as evidence | 10 verdicts (3 `supported`, 4 `partially supported`, 3 `unverifiable`) |
